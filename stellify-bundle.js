    ...
    price:{
      ...
      tiers:[
        {id:"free",name:L("Gratis","Gratuit","Gratuito","Free"),price:0,
         ...
         desc:L(
           "Schreib dein erstes Motivationsschreiben kostenlos. Du bekommst eine vollständige KI-Bewerbung und kannst 20 Fragen an Stella stellen – ganz ohne Abo.",
           "Write your first cover letter for free. One complete AI application and 20 questions to Stella – no subscription needed.",
           "Rédigez votre première lettre gratuitement. Une candidature complète et 20 questions à Stella – sans abonnement.",
           "Scrivi la tua prima lettera gratuitamente. Una candidatura completa e 20 domande a Stella – senza abbonamento."
         ),
         list:L([`${C.FREE_LIMIT} KI-Bewerbung`,"Motivationsschreiben","Lebenslauf","CV hochladen",`${C.CHAT_FREE_LIMIT} Chat-Fragen an Stella`],[`${C.FREE_LIMIT} AI application`,"Cover letter","CV","Upload CV",`${C.CHAT_FREE_LIMIT} questions to Stella`],[`${C.FREE_LIMIT} candidature IA`,"Lettre de motivation","CV","Upload CV",`${C.CHAT_FREE_LIMIT} questions à Stella`],[`${C.FREE_LIMIT} candidatura IA`,"Lettera motivazione","CV","Upload CV",`${C.CHAT_FREE_LIMIT} domande a Stella`]),
        ...
        {id:"pro",name:"Pro",priceM:19.90,priceY:14.90,best:true,
         ...
         desc:L(
           "Alle 20+ Tools ohne Einschränkungen. Dein Wochenkontingent wird jeden Montag um 07:00 Uhr automatisch aufgefüllt. Im Profil siehst du jederzeit wie viel noch übrig ist.",
           "All 20+ tools with no restrictions. Your weekly quota refills automatically every Monday at 07:00. Your profile always shows exactly how much is left.",
           "Tous les 20+ outils sans restriction. Votre quota hebdomadaire se recharge automatiquement chaque lundi à 07h00. Votre profil affiche toujours le solde restant.",
           "Tutti i 20+ strumenti senza restrizioni. Il tuo quota settimanale si ricarica automaticamente ogni lunedì alle 07:00. Il profilo mostra sempre quanto rimane."
         ),
         list:L(
           ["✍️ Alle 20+ Tools freigeschaltet","📊 Fortschrittsbalken im Profil","🔄 Wöchentlicher Refill jeden Montag","💼 LinkedIn Analyse & Optimierung","🤖 ATS-Simulation mit Score","📜 Zeugnis-Analyse & Decoder","🎯 Job-Matching (Top 5)","🎤 Interview-Coach (Note 0–100)","📋 Bewerbungs-Tracker","🔍 Swiss Bias-Checker","📈 Skill-Gap-Analyse"],
           ["✍️ All 20+ tools unlocked","📊 Progress bar in profile","🔄 Weekly refill every Monday","💼 LinkedIn analysis","🤖 ATS simulation","📜 Work reference analysis","🎯 Job matching (Top 5)","🎤 Interview coach","📋 Application tracker","🔍 Swiss bias checker","📈 Skill gap analysis"],
           ["✍️ Tous les 20+ outils","📊 Barre de progression","🔄 Rechargement hebdomadaire lundi","💼 LinkedIn","🤖 ATS","📜 Certificat","🎯 Matching","🎤 Coach","📋 Tracker","🔍 Biais suisse","📈 Analyse lacunes"],
           ["✍️ Tutti i 20+ strumenti","📊 Barra di avanzamento","🔄 Ricarica settimanale lunedì","💼 LinkedIn","🤖 ATS","📜 Certificato","🎯 Matching","🎤 Coach","📋 Tracker","🔍 Bias svizzero","📈 Analisi skill gap"]
         ),
        ...
        {id:"ultimate",name:L("Ultimate ♾️","Ultimate ♾️","Ultimate ♾️","Ultimate ♾️"),priceM:49.90,priceY:39.90,best:false,
         ...
         desc:L(
           "Kein Kontingent, kein Refill, kein Warten. Ideal für Karriereberater, HR-Profis und alle die Stellify täglich intensiv nutzen.",
           "No quota, no refill, no waiting. Ideal for career coaches, HR professionals and anyone using Stellify intensively every day.",
           "Aucun quota, aucune recharge, aucune attente. Idéal pour les coaches carrière et les professionnels RH qui utilisent Stellify quotidiennement.",
           "Nessuna quota, nessuna ricarica, nessuna attesa. Ideale per coach di carriera e professionisti HR che usano Stellify ogni giorno."
         ),
         list:L(
           ["♾️ Unbegrenzte Nutzung – keine Limits","✅ Alle 20+ Tools · alle 4 Sprachen","🔍 Swiss Bias-Checker","📈 Skill-Gap-Analyse","💼 LinkedIn Analyse & Optimierung","🤖 ATS-Simulation mit Score","📜 Zeugnis-Analyse & Decoder","🎯 Job-Matching (Top 5)","🎤 Interview-Coach","📋 Bewerbungs-Tracker","🛡️ Priority Support"],
           ["♾️ Unlimited usage – no limits","✅ All 20+ tools · all 4 languages","🔍 Swiss bias checker","📈 Skill gap analysis","💼 LinkedIn analysis","🤖 ATS simulation","📜 Reference analysis","🎯 Job matching","🎤 Interview coach","📋 Application tracker","🛡️ Priority support"],
           ["♾️ Usage illimité – aucune limite","✅ Tous 20+ outils","🔍 Biais suisse","📈 Lacunes compétences","💼 LinkedIn","🤖 ATS","📜 Certificat","🎯 Matching","🎤 Coach","📋 Tracker","🛡️ Support prioritaire"],
           ["♾️ Utilizzo illimitato – nessun limite","✅ Tutti 20+ strumenti","🔍 Bias svizzero","📈 Analisi skill gap","💼 LinkedIn","🤖 ATS","📜 Certificato","🎯 Matching","🎤 Coach","📋 Tracker","🛡️ Supporto prioritario"]
         ),
          ...
          <div className="pgrid">
            {t.price.tiers.map(tier=>(
              <div key={tier.id} className={`pc ${tier.best?"hl":""} ${tier.id==="ultimate"?"hl2":""}`}>
                ...
                {tier.desc&&<p style={{fontSize:13,color:"rgba(255,255,255,.4)",lineHeight:1.7,margin:"0 0 18px",fontWeight:300,borderTop:"1px solid rgba(255,255,255,.07)",paddingTop:14}}>{tier.desc[lang]||tier.desc.de}</p>}
                <ul className="pfl">
